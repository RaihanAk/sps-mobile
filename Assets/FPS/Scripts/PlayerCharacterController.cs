...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    public float touchHinput,
        touchVinput;
    public bool touchFire,
        touchJump,
        touchCrouch,
        touchAim;
    public Vector2 touchLookAxis;
    ...
    IEnumerator DelayCrouch()
    {
        // So that crouching state is delayed for 1 sec
    ...
    void HandleCharacterMovement()
    {
        // horizontal character rotation
        {
            ...
            transform.Rotate(new Vector3(0f, (touchLookAxis.x), 0f), Space.Self);
        }
        ...
        // vertical camera rotation
        {
            ...
            m_CameraVerticalAngle += -touchLookAxis.y * rotationSpeed * RotationMultiplier;
        ...
        bool isSprinting = m_InputHandler.GetSprintInputHeld();
        {
            ...
            // touch movement
            Vector3 move = new Vector3(touchHinput, 0f, touchVinput); 
            ...
            if (isGrounded)
            {
                ...
                // jumping
                if (isGrounded && m_InputHandler.GetJumpInputDown() || isGrounded && touchJump)
                {
