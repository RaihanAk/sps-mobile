...
public class PlayerInputHandler : MonoBehaviour
{
    ...
    {
        return Cursor.lockState == CursorLockMode.None && !m_GameFlowManager.gameIsEnding;
    }
    ...
    public bool GetFireInputHeld()
    {
        if (CanProcessInput())
        {
            ...
            else
            {
                ...
                return m_TouchController.Fire.Pressed;
            }
        }
    ...
    public bool GetAimInputHeld()
    {
        if (CanProcessInput())
        {
            ...
            bool i = isGamepad ? (Input.GetAxis(GameConstants.k_ButtonNameGamepadAim) > 0f) : m_TouchController.Aim.Pressed;
            return i;
        }
    ...
    public bool GetCrouchInputDown()
    {
        if (CanProcessInput())
        {
            ...
            return m_TouchController.Crouch.Pressed;
        }
